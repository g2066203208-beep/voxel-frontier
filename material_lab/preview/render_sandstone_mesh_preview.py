...
CFG={
    ...
    "vfPainterlyMoss":{"amp":.040,"lo":-.60,"hi":1.06,"nlat":96,"nlon":192,"geo":.40,"facet":.012,"subtitle":"fine moss mat shell · explicit tufts added after mesh"},
    "vfPainterlyWolfFur":{"amp":.026,"lo":-.72,"hi":1.06,"nlat":110,"nlon":220,"geo":.31,"facet":.0,"subtitle":"soft underfur shell · explicit guard hairs added after mesh"},
}
