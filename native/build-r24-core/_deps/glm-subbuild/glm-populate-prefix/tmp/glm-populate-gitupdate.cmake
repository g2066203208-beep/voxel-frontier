...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "1.0.3"
  WORKING_DIRECTORY "/home/runner/work/voxel-frontier/voxel-frontier/native/build-r24-core/_deps/glm-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/runner/work/voxel-frontier/voxel-frontier/native/build-r24-core/_deps/glm-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/runner/work/voxel-frontier/voxel-frontier/native/build-r24-core/_deps/glm-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
